...
class Login:
    ...
    def __login_del__(self):
        if messagebox.askyesno("Lõpetab", " jätke inventuur?") == True:
            self.loginw.destroy()
            exit(0)                   # SUNDID SÜSTEEM VÄLJUMA
    ...
    def obj(self):
        ...
        self.signin = Button(self.loginframe,width=20, text="Sisene",bg="lightblue2",fg="dimgray",command=self.checkuser,font="Roboto 14")
